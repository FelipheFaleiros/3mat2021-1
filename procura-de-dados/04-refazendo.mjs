...
//Como o conjunto de dados está ordenado por first_name, a busca binária por group_name falha 
//e retorna -1 como se a informação correspondente não existisse no conjunto de dados
