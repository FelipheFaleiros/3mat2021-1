/*       ALUNO __ FELIPHE FALEIROS ALARCON LIMA 
...
console.log(estadosNe) //ver se todos obj's foram inseridos
/*
...
const densidemogr = (area, popol) => popol / area
...
for(let i = 0; i < estadosNe.length; i++) {
   estadosNe[i]['densidade demográfica'] = densidemogr(estadosNe[i].area, estadosNe[i].populacao)
...
/*
   3) Percorra o vetor estadosNe usando um for tradicional. Para cada estado,
      ...
      demográfica' p'ara cada objeto representando um Estado.
